  ...
  return (
    <Page>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`https://filamartistdirectory.com/${artist.slug}`}
        />
        <meta property="og:type" content={`article`} />
        <meta
          property="og:title"
          content={`${artist.name} | Filipino American Artist Directory`}
        />
        <meta property="og:description" content={artist.metaDescription} />
        <meta
          property="og:image"
          content={`https:${artist.facebookShareImage.file.url}`}
        />
